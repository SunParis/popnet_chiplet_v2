...
#define RSCALE		(102.5)		/* wire resistance scaling factor */
#define LSCALE		0.0875		/* length (feature) scaling factor */
#define ASCALE		(LSCALE*LSCALE)	/* area scaling factor */
#define VSCALE		0.2		/* voltage scaling factor */
#define VTSCALE		0.183486	/* threshold voltage scaling factor */
/* FIXME: ??? */
...
#define Orion_Period          ((double)1/(double)PARM(Freq))
