...
class CXYRouter : public BaseRouter {
  ...
  public:
     ...
     */
    CXYRouter(const Config& config, AddrType addr, RouterList& routers, SimulationState& state,
...
class CTXYRouter : public BaseRouter {
  ...
  public:
     ...
     * @param router_list_ The list of routers
     */
    CTXYRouter(const Config& config, AddrType addr, RouterList& routers, SimulationState& state,
               InputTrace& input_trace, DelayWriter& delay_writer);
};
...
class CChipletMeshRouter : public BaseRouter {
  ...
  public:
     ...
     * @param router_list_ The list of routers
     */
    CChipletMeshRouter(const Config& config, AddrType addr, RouterList& routers,
...
class CChipletStarRouter : public BaseRouter {
  ...
  public:
     ...
     * @param router_list_ The list of routers
     */
    CChipletStarRouter(const Config& config, AddrType addr, RouterList& routers,
                       SimulationState& state, InputTrace& input_trace, DelayWriter& delay_writer);
};
