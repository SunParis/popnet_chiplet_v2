...
class TopoInfo {
  ...
  public:
    ...
    std::unordered_set<TimeType> routingPeriods;
...
class CGraphTopo : public BaseRouter {
  ...
  protected:
     ...
     */
    TimeType getPipeStageDelay() const override;
  ...
  public:
     ...
     */
    CGraphTopo(const Config& config, AddrType addr, RouterList& routers, TopoInfo& topology,
...
class ReconfigTopoInfo {
  ...
  public:
    ...
    bool hasNextReconfiguration() const noexcept;
...
class CReconfigTopoRouter : public BaseRouter {
  ...
  public:
    CReconfigTopoRouter(const Config& config, AddrType addr, RouterList& routers,
                        ReconfigTopoInfo& topology, SimulationState& state, InputTrace& input_trace,
