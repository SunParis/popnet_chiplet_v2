 ...
 */
enum class VCStateType { INIT, ROUTING, VC_AB, SW_AB, SW_TR, HOME };
 ...
 * @brief Flit type.
 */
enum class FlitType { HEADER, BODY, TAIL, SINGLE };
 ...
 */
enum class VCShareType { SHARE, MONO };
 ...
 */
enum class VCUsageType { USED, FREE };
 ...
 */
enum class SyncProtocolDesc { SPD_ACK, SPD_PRE_SYNC, SPD_POST_SYNC };
 ...
 */
enum class ProtoState { IDLE, PRE_SYNC, DATA_TRANS, ACK_TRANS, POST_SYNC, DONE };
